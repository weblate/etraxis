...
final class Version0400 extends AbstractExtendedMigration
{
    ...
    {
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(254) NOT NULL, password VARCHAR(255) DEFAULT NULL, reset_token VARCHAR(32) DEFAULT NULL, reset_token_expires_at INT DEFAULT NULL, fullname VARCHAR(50) NOT NULL, description VARCHAR(100) DEFAULT NULL, admin TINYINT(1) NOT NULL, disabled TINYINT(1) NOT NULL, account_provider VARCHAR(20) NOT NULL, account_uid VARCHAR(255) NOT NULL, settings LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', UNIQUE INDEX UNIQ_1483A5E9E7927C74 (email), UNIQUE INDEX UNIQ_1483A5E9D7C8DC19 (reset_token), UNIQUE INDEX UNIQ_1483A5E9EA0A912A13605F58 (account_provider, account_uid), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE field_role_permissions (role VARCHAR(20) NOT NULL, field_id INT NOT NULL, permission VARCHAR(10) NOT NULL, INDEX IDX_5D341D45443707B0 (field_id), PRIMARY KEY(field_id, role)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE field_group_permissions (field_id INT NOT NULL, group_id INT NOT NULL, permission VARCHAR(10) NOT NULL, INDEX IDX_47C8AF75443707B0 (field_id), INDEX IDX_47C8AF75FE54D947 (group_id), PRIMARY KEY(field_id, group_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE list_items (id INT AUTO_INCREMENT NOT NULL, field_id INT NOT NULL, value INT NOT NULL, text VARCHAR(50) NOT NULL, INDEX IDX_388D7D4E443707B0 (field_id), UNIQUE INDEX UNIQ_388D7D4E443707B01D775834 (field_id, value), UNIQUE INDEX UNIQ_388D7D4E443707B03B8BA7C7 (field_id, text), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    {
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(254) NOT NULL, password VARCHAR(255) DEFAULT NULL, reset_token VARCHAR(32) DEFAULT NULL, reset_token_expires_at INT DEFAULT NULL, fullname VARCHAR(50) NOT NULL, description VARCHAR(100) DEFAULT NULL, `admin` TINYINT(1) NOT NULL, disabled TINYINT(1) NOT NULL, account_provider VARCHAR(20) NOT NULL, account_uid VARCHAR(255) NOT NULL, settings JSON DEFAULT NULL, UNIQUE INDEX UNIQ_1483A5E9E7927C74 (email), UNIQUE INDEX UNIQ_1483A5E9D7C8DC19 (reset_token), UNIQUE INDEX UNIQ_1483A5E9EA0A912A13605F58 (account_provider, account_uid), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `groups` (id INT AUTO_INCREMENT NOT NULL, project_id INT DEFAULT NULL, name VARCHAR(25) NOT NULL, description VARCHAR(100) DEFAULT NULL, INDEX IDX_F06D3970166D1F9C (project_id), UNIQUE INDEX UNIQ_F06D3970166D1F9C5E237E06 (project_id, name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE membership (group_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_86FFD285FE54D947 (group_id), INDEX IDX_86FFD285A76ED395 (user_id), PRIMARY KEY(group_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE projects (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(25) NOT NULL, description VARCHAR(100) DEFAULT NULL, created_at INT NOT NULL, suspended TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_5C93B3A45E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE templates (id INT AUTO_INCREMENT NOT NULL, project_id INT NOT NULL, name VARCHAR(50) NOT NULL, prefix VARCHAR(5) NOT NULL, description VARCHAR(100) DEFAULT NULL, locked TINYINT(1) NOT NULL, critical_age INT DEFAULT NULL, frozen_time INT DEFAULT NULL, INDEX IDX_6F287D8E166D1F9C (project_id), UNIQUE INDEX UNIQ_6F287D8E166D1F9C5E237E06 (project_id, name), UNIQUE INDEX UNIQ_6F287D8E166D1F9C93B1868E (project_id, prefix), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    protected function upPostgreSQL(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE users (id INT NOT NULL, email VARCHAR(254) NOT NULL, password VARCHAR(255) DEFAULT NULL, reset_token VARCHAR(32) DEFAULT NULL, reset_token_expires_at INT DEFAULT NULL, fullname VARCHAR(50) NOT NULL, description VARCHAR(100) DEFAULT NULL, admin BOOLEAN NOT NULL, disabled BOOLEAN NOT NULL, account_provider VARCHAR(20) NOT NULL, account_uid VARCHAR(255) NOT NULL, settings JSONB DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE field_role_permissions (role VARCHAR(20) NOT NULL, field_id INT NOT NULL, permission VARCHAR(10) NOT NULL, PRIMARY KEY(field_id, role))');
        $this->addSql('CREATE INDEX IDX_5D341D45443707B0 ON field_role_permissions (field_id)');
        $this->addSql('CREATE TABLE field_group_permissions (field_id INT NOT NULL, group_id INT NOT NULL, permission VARCHAR(10) NOT NULL, PRIMARY KEY(field_id, group_id))');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_388D7D4E443707B01D775834 ON list_items (field_id, value)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_388D7D4E443707B03B8BA7C7 ON list_items (field_id, text)');
