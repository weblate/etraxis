...
final class Version0400 extends AbstractExtendedMigration
{
    ...
    protected function upMariaDB(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE field_role_permissions (role VARCHAR(20) NOT NULL, permission VARCHAR(10) NOT NULL, field_id INT NOT NULL, INDEX IDX_5D341D45443707B0 (field_id), PRIMARY KEY(field_id, role, permission)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE field_group_permissions (permission VARCHAR(10) NOT NULL, field_id INT NOT NULL, group_id INT NOT NULL, INDEX IDX_47C8AF75443707B0 (field_id), INDEX IDX_47C8AF75FE54D947 (group_id), PRIMARY KEY(field_id, group_id, permission)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE list_items (id INT AUTO_INCREMENT NOT NULL, field_id INT NOT NULL, item_value INT NOT NULL, item_text VARCHAR(50) NOT NULL, INDEX IDX_388D7D4E443707B0 (field_id), UNIQUE INDEX UNIQ_388D7D4E443707B037D043E4 (field_id, item_value), UNIQUE INDEX UNIQ_388D7D4E443707B0F3BBE33C (field_id, item_text), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    protected function upPostgreSQL(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE field_role_permissions (role VARCHAR(20) NOT NULL, permission VARCHAR(10) NOT NULL, field_id INT NOT NULL, PRIMARY KEY(field_id, role, permission))');
        $this->addSql('CREATE INDEX IDX_5D341D45443707B0 ON field_role_permissions (field_id)');
        $this->addSql('CREATE TABLE field_group_permissions (permission VARCHAR(10) NOT NULL, field_id INT NOT NULL, group_id INT NOT NULL, PRIMARY KEY(field_id, group_id, permission))');
        ...
        $this->addSql('CREATE TABLE list_items (id INT NOT NULL, field_id INT NOT NULL, item_value INT NOT NULL, item_text VARCHAR(50) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_388D7D4E443707B0 ON list_items (field_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_388D7D4E443707B037D043E4 ON list_items (field_id, item_value)');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_5387574A5E7AA58CA76ED3958CDE57298B8E8428 ON events (issue_id, user_id, type, created_at)');
