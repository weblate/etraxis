 ...
 * Command handler.
 */
final class EnableUsersCommandHandler implements CommandHandlerInterface
{
    /**
    ...
    public function __invoke(EnableUsersCommand $command): void
    {
        ...
        foreach ($accounts as $account) {
            if (!$this->security->isGranted(UserVoter::ENABLE_USER, $account)) {
                throw new AccessDeniedHttpException('You are not allowed to enable one of these users.');
            }
        }
