 ...
 */
final class CreateNumberFieldCommandHandlerTest extends TransactionalTestCase
{
    use LoginTrait;
    ...
    public function testSuccess(): void
    {
        ...
        $command = new CreateFieldCommand($state->getId(), 'Week number', FieldTypeEnum::Number, null, true, [
            Field::MINIMUM => 1,
            Field::MAXIMUM => 53,
            Field::DEFAULT => 7,
        ]);
        ...
        self::assertSame(FieldTypeEnum::Number, $field->getType());

        $strategy = $field->getStrategy();
        self::assertSame(1, $strategy->getParameter(Field::MINIMUM));
        self::assertSame(53, $strategy->getParameter(Field::MAXIMUM));
        self::assertSame(7, $strategy->getParameter(Field::DEFAULT));
    }
    ...
    public function testSuccessFallback(): void
    {
        ...
        $command = new CreateFieldCommand($state->getId(), 'Week number', FieldTypeEnum::Number, null, true, null);
