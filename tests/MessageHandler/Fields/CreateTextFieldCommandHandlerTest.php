...
final class CreateTextFieldCommandHandlerTest extends TransactionalTestCase
{
    ...
    public function testSuccess(): void
    {
        ...
        $command = new CreateFieldCommand($state->getId(), 'Body', FieldTypeEnum::Text, null, true, [
            Field::LENGTH       => 1000,
        ...
        self::assertSame(FieldTypeEnum::Text, $field->getType());

        $strategy = $field->getStrategy();
        self::assertSame(1000, $strategy->getParameter(Field::LENGTH));
        self::assertSame('Message body', $strategy->getParameter(Field::DEFAULT));
    ...
    public function testSuccessFallback(): void
    {
        ...
        $command = new CreateFieldCommand($state->getId(), 'Body', FieldTypeEnum::Text, null, true, null);
