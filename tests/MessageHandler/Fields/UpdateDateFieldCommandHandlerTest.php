 ...
 */
final class UpdateDateFieldCommandHandlerTest extends TransactionalTestCase
{
    use LoginTrait;
    ...
    public function testSuccess(): void
    {
        ...
        self::assertSame(14, $strategy->getParameter(Field::MAXIMUM));
        self::assertSame(14, $strategy->getParameter(Field::DEFAULT));
