 ...
 * @internal
 *
 * @covers \App\MessageHandler\Issues\CreateIssueCommandHandler::__invoke
 */
final class CreateIssueCommandHandlerTest extends TransactionalTestCase
{
    use LoginTrait;
    ...
    public function testSuccessNoResponsible(): void
    {
        ...
        $command = new CreateIssueCommand($template->getId(), 'Test issue', null, [
            $field1->getId() => 2,
    ...
    public function testSuccessWithResponsible(): void
    {
        ...
        $command = new CreateIssueCommand($template->getId(), 'Test issue', $user->getId(), [
            $field1->getId() => 2,
            $field2->getId() => 'Est dolorum omnis accusantium hic veritatis ut.',
            $field3->getId() => true,
        ]);
    ...
    public function testValidationSubjectLength(): void
    {
        ...
        $command = new CreateIssueCommand($template->getId(), str_pad('', Issue::MAX_SUBJECT + 1), null, [
            $field1->getId() => 2,
        ]);
    ...
    public function testValidationRequiredFields(): void
    {
        ...
        $command = new CreateIssueCommand($template->getId(), 'Test issue', null, null);
    ...
    public function testValidationOnTextField(): void
    {
        ...
        $command = new CreateIssueCommand($template->getId(), 'Test issue', null, [
            $field1->getId() => 2,
            $field2->getId() => str_pad('', TextValue::MAX_VALUE + 1, '*'),
            $field3->getId() => true,
        ]);
    ...
    public function testValidationOnCheckboxField(): void
    {
        ...
        try {
            ...
            self::assertSame('\'New feature\' should be \'false\' or \'true\'.', $exception->getViolations()->get(0)->getMessage());
    ...
    public function testUnknownTemplate(): void
    {
        ...
        $command = new CreateIssueCommand(self::UNKNOWN_ENTITY_ID, 'Test issue', null, [
            $field1->getId() => 2,
        ]);
    ...
    public function testUnknownResponsible(): void
    {
        ...
        $command = new CreateIssueCommand($template->getId(), 'Test issue', self::UNKNOWN_ENTITY_ID, [
            $field1->getId() => 2,
        ]);
